<?php
  ...
  $appointments = getUsersAppointment($_SESSION['user']);
?>
                    ...
                    <div class="container-fluid">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-lg-12 col-sm-12">
                                          <div class="widget-inline-box text-center">
                                              <h3 class="m-t-10"><i class="text-info mdi mdi-black-mesa"></i> <b><?= getTotalUserAppointment('appointments', $_SESSION['user']); ?></b></h3>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <a href="../appointment.php" class="btn btn-primary btn-sm">Book Appointment</a>
                            </div>
                        </div>
