                        ...
                        <li class="dropdown notification-list">
                            <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="#" role="button"
                               aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="badge badge-danger badge-pill noti-icon-badge"><?= getTotalUserAppointment("appointments", $_SESSION['user']); ?></span>
                            </a>
                        </li>
            ...
            <div class="left side-menu">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);"><i class="ti-user"></i> <span> User Details </span> <span class="menu-arrow"></span></a>
