                                    ...
                                    <form class="form-horizontal" action="" method="post">
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-12">
                                                ...
                                                <input name="username" class="form-control" type="text" id="username" required="" placeholder="johndoe">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b-20">
                                            <div class="col-12">
                                                ...
                                                <input name="confirm_password" class="form-control" type="cpassword" required="" id="password" placeholder="Confirm your password">
                                            </div>
                                        </div>
